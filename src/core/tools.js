...
export async function executeTool(name, args) {
  try {
    switch (name) {
      ...
      case "calculator":
        // Bolt: Optimized with regex sanitization for security and performance (prevents engine overhead on invalid input)
      ...
      case "execute_python_code":
        return "Error: Python code execution is currently disabled for security reasons.";
