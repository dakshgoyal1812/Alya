    ...
    switch (name) {
          ...
          if (process.platform === "win32") {
            ...
            if (lines.length >= 2) {
              ...
              return JSON.stringify({
                ...
                usagePercent: parts[4] || Math.round((usedKB / (totalKB || 1)) * 100) + "%"
              });
            }
          }
        } catch (e) {
      ...
      case "read_website": {
        try {
          ...
          if (parsed.protocol !== "http:" && parsed.protocol !== "https:") {
            return "Security Error: Only http and https protocols are allowed.";
          }
          ...
          if (
            ...
            return "Security Error: Cannot fetch local, internal, or restricted network addresses.";
          }
      ...
      case "read_pdf": {
        try {
          ...
          if (rawPath.includes("..")) {
            return "Security Error: Relative path traversal sequences ('..') are blocked.";
          }
          ...
          if (
            ...
            normalizedPath.includes("windows/system")
          ) {
            return "Security Error: Access to sensitive system path is blocked.";
          }
      ...
      case "execute_python_code": {
        return "Security Error: Arbitrary Python code execution is disabled for safety.";
      }
