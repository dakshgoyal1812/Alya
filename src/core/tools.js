...
export async function executeTool(name, args) {
  try {
    switch (name) {
      ...
      case "calculator":
        // ⚡ Bolt: Basic input sanitization to prevent RCE via new Function()
      ...
      case "execute_python_code": {
        return "Critical Error: Python execution is disabled for security reasons (RCE prevention). Please use the calculator for math or perform logic conversationally.";
      }
