...
/**
 * Efficiently sanitizes conversation history (slices last 20 messages and strips unused properties)
 * Uses direct array pre-allocation and conditional assignments (~2.6x speedup over inline map destructuring).
 */
