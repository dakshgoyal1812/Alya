...
/**
 * Save a conversation to disk (Asynchronous version)
 * ⚡ Bolt: Use async writeFile to avoid blocking the event loop
 */
...
/**
 * Save a conversation to disk (Synchronous version for process exit)
 */
...
/**
 * Flush all conversations to disk (Synchronous for exit)
 */
export function flushAllSync() {
