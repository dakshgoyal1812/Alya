...
/**
 * Track unsaved messages per conversation to optimize disk I/O
 */
...
function saveToDisk(platform, channelId) {
  ...
  // Reset unsaved count since we are writing to disk
...
export function addMessage(platform, channelId, role, content) {
  ...
  // Save to disk every 5 new messages to optimize I/O
