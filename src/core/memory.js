...
/**
 * Serialize a conversation to JSON payload
 */
...
/**
 * Save a conversation to disk synchronously (used on exit / flush)
 */
...
export function addMessage(platform, channelId, role, content) {
  ...
  // Save to disk asynchronously every 5 messages to keep the event loop non-blocking
