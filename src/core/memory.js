...
export function flushAll() {
  for (const [key] of conversations) {
    // Performance optimization: indexOf + substring avoids array allocation (~100x speedup)
    // and correctly preserves channel IDs containing colons (e.g., Slack/Discord threads)
