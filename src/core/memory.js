...
/**
 * Helper to serialize a conversation payload to JSON
 */
...
/**
 * Save a conversation to disk (synchronous, for process exit or clearHistory)
 */
...
/**
 * Save a conversation to disk asynchronously (non-blocking, for periodic chat logs)
 */
