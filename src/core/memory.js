...
/**
 * Save a conversation to disk asynchronously to avoid blocking the event loop on hot paths.
 * Expected performance impact: Non-blocking I/O operations for periodic message persistence.
 */
...
export function addMessage(platform, channelId, role, content) {
  ...
  if (history.length % 5 === 0) {
    // Bolt: Use asynchronous write on the hot path to keep message processing lightning-fast and non-blocking
